...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/maxsmi-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14710&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/maxsmi-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `maxsmi` can be installed with:

```
conda install maxsmi
```

It is possible to list all of the versions of `maxsmi` available on your platform with:
